...
OUTPUT_DIR = BASE_DIR / "results175_late"

INPUT_FILE = Path(__file__).resolve().parent / "Subj533_therapeutic_late_175.csv"

OUTPUT_FILE = OUTPUT_DIR / "Subj533_phaseC_late175.csv"
EXEC_LOG = OUTPUT_DIR / "phaseC_late175_execution_log.json"
ROW_LOG = OUTPUT_DIR / "phaseC_late175_row_log.jsonl"
