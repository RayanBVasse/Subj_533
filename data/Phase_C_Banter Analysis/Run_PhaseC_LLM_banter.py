...
OUTPUT_DIR = BASE_DIR / "banter_results"

INPUT_FILE = Path(__file__).resolve().parent / "Subj533_late_banter_only.csv"

OUTPUT_FILE = OUTPUT_DIR / "Subj533_phaseC_latebanter.csv"
EXEC_LOG = OUTPUT_DIR / "phaseC_latebanter_execution_log.json"
ROW_LOG = OUTPUT_DIR / "phaseC_latebanter_row_log.jsonl"
